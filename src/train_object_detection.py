...
if __name__ == '__main__':
    ...
    train_dataloader = DataLoader(train_split, batch_size=config.model.batch_size, collate_fn=collate_fn, shuffle=True, num_workers=4, persistent_workers=True)
    val_dataloader = DataLoader(val_split, batch_size=config.model.batch_size, collate_fn=collate_fn, num_workers=4, persistent_workers=True)
